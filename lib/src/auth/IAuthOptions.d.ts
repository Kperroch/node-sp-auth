...
export declare type IAuthOptions = IOnlineAddinCredentials | IOnPremiseAddinCredentials | IUserCredentials | IOnpremiseUserCredentials | IAdfsUserCredentials | IOnDemandCredentials | IOnlineAppCert;
...
export declare function isAppCertOnline(T: IAuthOptions): T is IOnlineAppCert;
